...
class Smarty extends Smarty_Internal_TemplateBase
{
     ...
     * @var array
     */
    private $template_dir = array('././application/view/templates/');
     ...
     * @var string
     */
    private $compile_dir = '././application/view/template_c/';
     ...
     * @var array
     */
    private $config_dir = array('././application/view/config/');
    ...
    public function init($titleName)
    {
        if(isset($_SESSION['current_user']))
        {
            $managerData = $_SESSION['current_user'];
            $managerName = $managerData['user_first_name'] . " " . $managerData['user_last_name'];
        }
        $this->assign('title', $titleName);
        $this->assign('admin_url', App::URL);
        $this->assign('site_url', App::SITE_URL);
        $this->assign('ajax_path', App::URL . 'ajax/');
        $this->assign('uploads_path', App::URL . 'uploads/');
        $this->assign('css_path', App::SHORT_URL . App::$css_dir);
        $this->assign('css_libs_path', App::SHORT_URL . App::$css_libs_dir);
        $this->assign('js_path', App::SHORT_URL . App::$js_dir);
        $this->assign('js_libs_path', App::SHORT_URL . App::$js_libs_dir);
        $this->assign('libs_path', App::SHORT_URL . App::$libs_dir);
        $this->assign('img_path', App::SHORT_URL . App::$img_dir);
        $this->assign('date_now', date('d.m.Y h:i:s'));
        $this->assign('plugins_path', App::SHORT_URL . App::$plugin_dir);
        $this->assign('dist_path', App::SHORT_URL . App::$dist_dir);
        $this->assign('bootstrap_path', App::SHORT_URL . App::$bootstrap_dir);


        $user = Database::GetRow("SELECT * FROM admins WHERE id = :id",
            array(':id' => Auth::getCurrentUserId()));

        $this->assign('current_id', $user['id']);
        $this->assign('user_first_name', $user['first_name']);
        $this->assign('user_last_name', $user['last_name']);
        /*$this->assign('permissions', Session::getVar('permissions'));
        $this->assign('update_access', Perm::getAccessRight('update'));
        $this->assign('delete_access', Perm::getAccessRight('delete'));
        $this->assign('manager_name', $managerName);*/
    }
