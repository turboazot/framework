<?php /* Smarty version 3.1.27, created on 2016-02-22 16:19:28
         compiled from "D:\Ampps\www\absolute\admin\application\view\templates\prt_trainer-table.tpl" */ ?>
<?php
/*%%SmartyHeaderCode:846056cb18f01601d2_08057892%%*/
if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '0e9b0fcb3bdd6cbe821bfa7e04ee81af87cf358b' => 
    array (
      0 => 'D:\\Ampps\\www\\absolute\\admin\\application\\view\\templates\\prt_trainer-table.tpl',
      1 => 1453152062,
      2 => 'file',
    ),
    ...
    '112475590fc2814596affe13788d8fbfed4d4996' => 
    array (
      0 => '112475590fc2814596affe13788d8fbfed4d4996',
      1 => 0,
      2 => 'string',
    ),
  ...
  'nocache_hash' => '846056cb18f01601d2_08057892',
  'variables' => 
  array (
    'css_libs_path' => 0,
    'js_libs_path' => 0,
  ...
  'version' => '3.1.27',
  'unifunc' => 'content_56cb18f03198c0_56390435',
),false);
/*/%%SmartyHeaderCode%%*/
if ($_valid && !is_callable('content_56cb18f03198c0_56390435')) {
function content_56cb18f03198c0_56390435 ($_smarty_tpl) {

$_smarty_tpl->properties['nocache_hash'] = '846056cb18f01601d2_08057892';
?>
<!doctype html>
<html lang="en"><head>
    <meta charset="utf-8">
...
echo $_smarty_tpl->getInlineSubTemplate("prt_sidebar.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, '2185156cb18f024e698_39474466', 'content_56cb18f024e696_95028331');
...
echo $_smarty_tpl->getInlineSubTemplate("prt_panel-header.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, '2222556cb18f0275798_07304178', 'content_56cb18f0271917_72369759');
...
?>
                <tr>
                    ...
                    <td id="description"><?php echo $_smarty_tpl->tpl_vars['profile']->value['profile_description'];?>
</td>
                    <td class="row-panel">
                        <a title="Перейти" target="_blank" href="<?php echo $_smarty_tpl->tpl_vars['profile']->value['url'];?>
"><i class="fa fa-eye"></i></a>
                        <a title="Редактировать описание" id="edit_description" href="#"><i class="fa fa-pencil"></i></a>
                        <a title="Удалить" href="#myModal" id="pre_delete_trainer" role="button" data-toggle="modal"><i class="fa fa-trash-o"></i></a>
                    </td>
                </tr>
            <?php
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <p class="error-text"><i class="fa fa-warning modal-icon"></i>Вы уверены что хотите удалить этого тренера?<br>Это действие нельзя будет отменить!</p>
                    </div>
                    <div class="modal-footer">
                        <button class="btn btn-default" data-dismiss="modal" aria-hidden="true">Отменить</button>
                        <button class="btn btn-danger" id="delete_trainer" data-dismiss="modal">Удалить</button>
                    </div>
                </div>
            </div>
        </div>
        <div class="modal fade" id="editDescriptionModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="edit_trainer_description">редактировать описание</button>
                    </div>
                </div>
            </div>
            <link rel="stylesheet" href="<?php echo $_smarty_tpl->tpl_vars['css_libs_path']->value;?>
bootstrap/bootstrap-datetimepicker.min.css"/>
            <style type="text/css">
                ...
                #editDescriptionModal #trainer_description {
                    width: 100%;
                    padding: 10px;
                    height: 100px;
                }
...
trainer-table.js"><?php echo '</script'; ?>
>
    </div>


            <?php /*  Call merged included template "prt_footer.tpl" */
echo $_smarty_tpl->getInlineSubTemplate("prt_footer.tpl", $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array(), 0, '2770356cb18f02fa4b8_86613375', 'content_56cb18f02fa4b0_07402091');
...
?><?php
/*%%SmartyHeaderCode:2185156cb18f024e698_39474466%%*/
if ($_valid && !is_callable('content_56cb18f024e696_95028331')) {
function content_56cb18f024e696_95028331 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '2185156cb18f024e698_39474466';
?>
...
/*/%%SmartyNocache:2185156cb18f024e698_39474466%%*/
}
}
?><?php
/*%%SmartyHeaderCode:2222556cb18f0275798_07304178%%*/
if ($_valid && !is_callable('content_56cb18f0271917_72369759')) {
function content_56cb18f0271917_72369759 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '2222556cb18f0275798_07304178';
?>
<div class="header">
    <h1 class="page-title"><?php echo $_smarty_tpl->tpl_vars['title']->value;?>
</h1>
</div><?php
/*/%%SmartyNocache:2222556cb18f0275798_07304178%%*/
}
}
?><?php
/*%%SmartyHeaderCode:2770356cb18f02fa4b8_86613375%%*/
if ($_valid && !is_callable('content_56cb18f02fa4b0_07402091')) {
function content_56cb18f02fa4b0_07402091 ($_smarty_tpl) {
?>
<?php
$_smarty_tpl->properties['nocache_hash'] = '2770356cb18f02fa4b8_86613375';
?>
<footer>
    <hr>
...
/*/%%SmartyNocache:2770356cb18f02fa4b8_86613375%%*/
}
}
?>